...
def buyVolRatioPiecewise(df, para):
    ...
    weight = np.where(ratio > para, 1,
                      np.where(ratio < -para, 0, 0.5))
...
calcbuyVolRatioPiecewise1 = lambda df2d: calc(df2d, 0.1)
calcbuyVolRatioPiecewise2 = lambda df2d: calc(df2d, 0.2)
calcbuyVolRatioPiecewise3 = lambda df2d: calc(df2d, 0.3)
calcbuyVolRatioPiecewise4 = lambda df2d: calc(df2d, 0.4)